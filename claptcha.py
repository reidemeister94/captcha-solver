...
class Claptcha(object):
    ...
    def __init__(self, source, font, size=(200, 80), margin=(20, 20), **kwargs):
        ...
        self.noise = abs(kwargs.get("noise", 0.0))
    ...
    def image(self):
        ...
        image = Image.new("RGB", (w + 2 * margin_x, h + 2 * margin_y), (255, 255, 255))
    ...
    def _writeText(self, image, text, pos):
        ...
        for c in text:
            ...
            c_draw.text((0, 0), c, font=self.font, fill=(60, 70, 120, 255))
    ...
    def _whiteNoise(self, size):
        ...
        if self.noise > 0.003921569:  # 1./255.
            ...
            rnd_grid = map(lambda _: tuple([pixel(self.noise)]) * 3, [0] * w * h)
    ...
    def _quadPoints(size, disp1, disp2):
        ...
        return (x1, -y1, -x1, h + y2, w + x2, h - y2, w - x2, y1)
